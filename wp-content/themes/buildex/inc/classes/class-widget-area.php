...
if ( ! class_exists( 'Buildex_Widget_Area' ) ) {

	class Buildex_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'buildex-theme/widget-area/render', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'buildex-theme/widget_area/rendering_current', $area_id );
			...
			$classes = apply_filters( 'buildex-theme/widget_area/classes', $classes, $area_id );
	...
	function buildex_widget_area() {
		return Buildex_Widget_Area::get_instance();
	}
