...
function buildex_main_menu() {
	...
	<nav id="site-navigation" class="<?php echo join( ' ', $classes ); ?>" role="navigation">
		...
		<?php
			$args = apply_filters( 'buildex-theme/menu/main-menu-args', array(
				'theme_location'   => 'main',
				'container'        => '',
				'menu_id'          => 'main-menu',
				'fallback_cb'      => 'buildex_set_nav_menu',
				'fallback_message' => esc_html__( 'Set main menu', 'buildex' ),
			) );
 ...
 * @return void
 */
function buildex_footer_menu() { ?>
	<nav id="footer-navigation" class="footer-menu" role="navigation">
	<?php
		$args = apply_filters( 'buildex-theme/menu/footer-menu-args', array(
			...
			'fallback_message' => esc_html__( 'Set footer menu', 'buildex' ),
		) );
 ...
 * @return string
 */
function buildex_get_social_list( $context, $type = 'icon' ) {
	static $instance = 0;
	$instance++;
	...
	$args = apply_filters( 'buildex-theme/social/list-args', array(
		...
		'echo'             => false,
		'fallback_cb'      => 'buildex_set_nav_menu',
		'fallback_message' => esc_html__( 'Set social menu', 'buildex' ),
	), $context, $type );
 ...
 * @return void
 */
function buildex_set_nav_menu( $args ) {
