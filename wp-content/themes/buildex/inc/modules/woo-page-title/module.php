...
if ( ! class_exists( 'Buildex_Woo_Page_Title_Module' ) ) {

	/**
	 * Define Buildex_Woo_Page_Title_Module class
	 */
	class Buildex_Woo_Page_Title_Module extends Buildex_Module_Base {
