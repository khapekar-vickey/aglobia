...
if ( ! class_exists( 'Buildex_Woo_Breadcrumbs_Module' ) ) {

	/**
	 * Define Buildex_Woo_Breadcrumbs_Module class
	 */
	class Buildex_Woo_Breadcrumbs_Module extends Buildex_Module_Base {
		...
		public function get_wc_breadcrumbs( $is_custom_breadcrumbs, $args ) {
			...
			$wc_breadcrumbs = new Buildex_WC_Breadcrumbs( $args );
