...
//$cust_pro_normal_img_url = "https://image.icarefurnishers.com/images/".$sku."/".$attribute_name."/".$terms."/Normal/image01.jpg";
//$cust_pro_data_img_url = "https://image.icarefurnishers.com/images/".$sku."/".$attribute_name."/".$terms."/Normal/image##.jpg|01..24";
/*
echo "<pre>";
print_r("SKU = ".$sku);
echo"\n";
    ...
    <div class="container">
        <div class="row customizer-top">
            <div class="col-md-8">
                ...
                <!--thumbnail slider for gallery images-->    
            ...
            <div class="col-md-4">
    			...
    			<div class="customize-add-to-cart-btn mt-4 mb-4">
					...
					<a href="<?php echo home_url('/cart/?add-to-cart='.$porudctId);?>">Buy Now</a>
    			</div>
            </div><!-- col-md-4 -->
        </div>       
        <!-- Description -->
