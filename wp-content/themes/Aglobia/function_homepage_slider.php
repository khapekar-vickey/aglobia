...
// Slider with Bootstrap Carosoul
if ( is_home() || is_front_page() ) { ?>
  <div class="aglobia-slider carousel  slide" data-ride="carousel" data-interval="3000" id="ag-carousel">
  <!-- Overlay -->
  <div class="overlay"></div>
  <!-- Indicators -->
  <ol class="carousel-indicators">
    <li data-target="#ag-carousel" data-slide-to="0" class="active"></li>
    <li data-target="#ag-carousel" data-slide-to="1"></li>
    <li data-target="#ag-carousel" data-slide-to="2"></li>
  </ol>
        ...
        <?php
            ...
            if($sliderPost->have_posts())
            {
                ...
                while ($sliderPost->have_posts())
                {
                  ...
                  $post_content = substr($sliderPost->post->post_content,0,1000);
                  $post_thumbnail_id = get_post_thumbnail_id($post_ID);
                  ...
                  if($post_content){
                    $sub_caption = $post_content;
                  }
                  $active = "active";
        ?>
        <div class="carousel-item slides <?php if ($i==1) echo $active ; ?>">
          <div class="slide" style="background-image: url(<?php echo $thumbimg; ?>);"></div>
      ...
      <a class="carousel-control-prev" href="#ag-carousel" role="button" data-slide="prev">
        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
        <span class="sr-only">Previous</span>
      </a>
      <a class="carousel-control-next" href="#ag-carousel" role="button" data-slide="next">
