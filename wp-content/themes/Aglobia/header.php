...
<div id="page" class="site">
		...
		<div class="buttom-header">
			<div class="container">
				<div class="header-logo-warapper">
                    ...
                    <div class="mobi-search"><span data-toggle="modal" data-target="#modal-search"><i class="fa fa-search"></i></span></div>
    ...
    <div class="modal" id="modal-search" style="display: none;">
    	<div class="home-search">
        	<form role="search" method="get" id="searchform3" class="form_search" action="<?php echo home_url( '/' );?>" >
				<input type="text" value="<?php echo get_search_query();?>" name="s" id="s" class="form-control search-in" placeholder="Type Keyword..." aria-label="Recipient's username" aria-describedby="basic-addon2">
				<div class="input-group-append">
				<button class="btn btn-outline-secondary" type="submit"><i class="fa fa-search"></i></button>
				</div>
