...
jQuery(document).ready(function($) {
  ...
  if($(".top-selling-owl-carousel"). length){
  ...
  if($(".new-modular-furniture-owl-carousel"). length){
  ...
  // new-modular-furniture-owl-carousel
  if($(".trendy_furniture-owl-carousel"). length){
  ...
  if($(".myinteriordefine-slider"). length){
  ...
  //Sticky nav on customization page
  if ( $('body').hasClass('page-template-product_customize')) {
     $(window).scroll(function(){
  ...
  // thumbnail gallery section on customization pdp
    if ( $('body').hasClass('page-template-product_customize')){
      var slidesPerPage = 6;
      $('#thumbnailSlider').find(".owl-item").removeClass("active");
      // carousel function for thumbnail slider
      jQuery('#thumbnailSlider').owlCarousel({
          ...
          jQuery(this).addClass("active");
          var src = jQuery(this).attr('src');
          jQuery("#slidermain_img").attr('src',src);
      });
    }
...
// Document.ready fuction close(2nd)