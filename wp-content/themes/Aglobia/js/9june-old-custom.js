	...
	jQuery.ajax ({
		...
		success:function(results) 
		{
		  ...
		  /******** (Vickey) Updateed code ************/
			...
			var img_src = "https://image.icarefurnishers.com/images/"+sku_val+"/"+termkey_val+"/"+value1+"/Normal/sofa01.jpg";
			console.log('img_src = ' + img_src);
			//jQuery('#Viewaddtocart_data').append(results);
			//jQuery("#custom_prd_slider #slidermain_img").attr("src",results);
			jQuery('#customize-preloader').hide();
			jQuery("#custom_prd_slider #slidermain_img").attr("class","reel");
			jQuery(".custom-slide-img #custom_prd_slider #slidermain_img").attr("src",img_src);
			jQuery("#slidermain_img").attr("data-images","https://image.icarefurnishers.com/images/"+sku_val+"/"+termkey_val+"/"+value1+"/Normal/sofa##.jpg|01..24");
			
			// for madal 
			//jQuery("#ImgzoomModal #zoom_slidermain_img").attr("src",results);
			jQuery('#customize-preloader').hide();
			jQuery("#ImgzoomModal #zoom_slidermain_img").attr("class","reel");
			jQuery("#ImgzoomModal #zoom_slidermain_img").attr("src",img_src);
			jQuery("#ImgzoomModal #zoom_slidermain_img").attr("data-images","https://image.icarefurnishers.com/images/"+sku_val+"/"+termkey_val+"/"+value1+"/Normal/sofa##.jpg|01..24");
...
/* *************** Category/shop Landing page ************************* */
   jQuery('.cat-slider .owl-carousel').owlCarousel({
    items :6,
    rtl:false,
    loop:true,
    margin:10,
