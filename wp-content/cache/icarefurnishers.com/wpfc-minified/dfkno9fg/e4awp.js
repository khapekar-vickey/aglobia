// source --> https://icarefurnishers.com/wp-content/themes/icarefurnishers/textlocal_sms/verification.js 
...
function sendOTP() {
	...
	if (number.length == 10 && number != null && user_email !=null) {
		...
		jQuery.ajax({
			url : 'wp-content/themes/wp-store/textlocal_sms/controller.php',
			type : 'POST',
			data : input,
			success : function(response) {
