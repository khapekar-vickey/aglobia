							...
							<tbody>
								<tr valign="top" class="">
									<td scope="row" class="input_file_cl" colspan="2">
										...
										<p><?php _e('This tool allows you to import tracking information to your orders from a CSV file.', 'woo-advanced-shipment-tracking'); ?></p>
									</td>
								</tr> 
								<tr valign="top" class="border-bottom-0">
									<th scope="row" class="th_80">
										<label for=""><?php _e('Choose a CSV file from your computer:', 'woocommerce'); ?></label>
									</th>
