...
Tags: delivery date, delivery time, same day delivery, pickup date, estimated date, next day delivery, delivery
...
The plugin helps you **control your local deliveries** & ensures that you, as a store owner, **never miss a delivery**.
...
= 3.10.2 (31.03.2020) =
* Feature - You can now place the delivery calendar between the "Your Order" & "Payment" Section.
* Fix - Fixed some CSS issues in the plugin's admin dashboard.
